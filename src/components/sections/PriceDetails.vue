<template>
  <section>
    <div class="container max-w-full mx-auto py-12 px-6">
      <h1
        class="text-center font-display font-bold text-typo text-4xl leading-snug tracking-wider"
      >
        Obtén Imágenes de Alta Resolución
      </h1>
      <p class="text-center text-lg text-gray-700 mt-2 px-6">
        1 imagen = 1 crédito o menos
      </p>
        ...
        <div class="relative block flex flex-col md:flex-row items-center">
          ...
          >
            ...
            >
              ...
              >
                ...
                Credits disponibles para usar en cualquier momento dentro de los
                dos años posteriores a la compra.
              </div>
              ...
              <div class="flex flex-wrap mt-3 px-6">
                <ul>
                  <li class="flex items-center">
                    ...
                    <span class="text-gray-700 text-lg ml-3">Flexible</span>
                  </li>
                  <li class="flex items-center">
                    <div class="rounded-full p-2 fill-current text-green-700">
                      <svg
              ...
              <div class="block flex items-center p-8 uppercase">
                <button
                  class="mt-3 text-lg font-semibold bg-brand w-full text-white rounded-lg px-6 py-3 block shadow-xl hover:bg-gray-700"
                >
                  Comprar Ya
                </button>
              </div>
          ...
          >
            ...
            >
              ...
              <h2 class="text-sm text-gray-500 text-center pb-6">
                <span class="text-3xl">$39</span> /mo
              </h2>

              Garantía de devolución de dinero de 14 días. 200 créditos al mes
              al mejor precio.
            </div>
          ...
          >
            ...
            >
              ...
              >
                ...
                <h2 class="text-sm text-gray-500 text-center pb-6">
                  Mas de 100000 imagenes /mo
                </h2>

                Comunicate con nosotros para obtener una cotización
                personalizada.
              </div>
              <div class="flex flex-wrap mt-3 px-6">
                <ul>
                  ...
                  <li class="flex items-center">
                    ...
                    <span class="text-gray-700 text-lg ml-3"
                      >Gestor dedicado al cliente</span
                    >
                  </li>
                </ul>
              </div>
